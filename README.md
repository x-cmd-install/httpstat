...
[![x-cmd/install — httpstat Code Quality Monitoring Repo Card](https://x-cmd.com/repo-card/httpstat.svg)](https://x-cmd.com/install/httpstat)
...
Total: **887** lines of code across **6** files in the top 5 languages.
...
- **Upstream**: <https://github.com/reorx/httpstat>
- **License**: MIT
...
- **Stars**: 6,221 · **Forks**: 383 · **Open issues**: 26 · **Contributors**: 6

## Totals (cumulative)

- **Releases**: 5 · **Merged PRs**: 10 · **Open PRs**: 5 · **Closed issues**: 22 · **Open issues**: 4 · **Commits**: 106
...
_Snapshot: `data/card/260925.yml` · 2026-09-25T02:45:43Z._
